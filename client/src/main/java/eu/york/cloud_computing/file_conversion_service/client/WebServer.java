...
import eu.york.cloud_computing.file_conversion_service.client.controllers.PageController;
...
public class WebServer {
    ...
    @Bean
    public UserResponderService text2pdfService() {
        return new UserResponderService(TXT2PDF_SERVICE_URL);
    }
    ...
    @Bean
    public PageController homeController() {
